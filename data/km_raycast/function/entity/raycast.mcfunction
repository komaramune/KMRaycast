...
#   storage km_raycast: EntityRaycast.Arguments.LineLength: 線の長さ
...
# 引数コピー
execute store result score $LineLength KMRaycast run data get storage km_raycast: EntityRaycast.Arguments.LineLength 256
...
execute store result storage km_raycast: EntityRaycast.Returns.RemainingLength double 0.00390625 run data get storage km_raycast: EntityRaycast.Arguments.LineLength 256
