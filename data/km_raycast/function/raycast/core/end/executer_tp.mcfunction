#> km_raycast:raycast/core/end/executer_tp
...
execute store result storage km_raycast: Raycast.Macro.TPX double 0.001 run scoreboard players get $TPX KMRaycast
...
execute store result storage km_raycast: Raycast.Macro.TPY double 0.001 run scoreboard players get $TPY KMRaycast
...
execute store result storage km_raycast: Raycast.Macro.TPZ double 0.001 run scoreboard players get $TPZ KMRaycast
