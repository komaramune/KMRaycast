...
execute unless score $LastCollideAxis KMRaycast matches 0 store result storage km_raycast: BlockRaycast.Macro.TPX double 0.001 run scoreboard players get $TPX KMRaycast
execute if score $LastCollideAxis KMRaycast matches 0 store result storage km_raycast: BlockRaycast.Macro.TPX double 0.00100001 run scoreboard players get $TPX KMRaycast
...
execute unless score $LastCollideAxis KMRaycast matches 1 store result storage km_raycast: BlockRaycast.Macro.TPY double 0.001 run scoreboard players get $TPY KMRaycast
execute if score $LastCollideAxis KMRaycast matches 1 store result storage km_raycast: BlockRaycast.Macro.TPY double 0.00100001 run scoreboard players get $TPY KMRaycast
...
execute unless score $LastCollideAxis KMRaycast matches 2 store result storage km_raycast: BlockRaycast.Macro.TPZ double 0.001 run scoreboard players get $TPZ KMRaycast
execute if score $LastCollideAxis KMRaycast matches 2 store result storage km_raycast: BlockRaycast.Macro.TPZ double 0.00100001 run scoreboard players get $TPZ KMRaycast
