...
execute store result score $UnitX KMRaycast run data get storage km_raycast: BlockRaycast.Pos[0] 1000
execute store result score $UnitY KMRaycast run data get storage km_raycast: BlockRaycast.Pos[1] 1000
execute store result score $UnitZ KMRaycast run data get storage km_raycast: BlockRaycast.Pos[2] 1000
...
data modify storage km_raycast: BlockRaycast.Pos set from entity @s Pos
execute store result score $DeltaX KMRaycast run data get storage km_raycast: BlockRaycast.Pos[0] -1000
execute store result score $DeltaY KMRaycast run data get storage km_raycast: BlockRaycast.Pos[1] -1000
execute store result score $DeltaZ KMRaycast run data get storage km_raycast: BlockRaycast.Pos[2] -1000
