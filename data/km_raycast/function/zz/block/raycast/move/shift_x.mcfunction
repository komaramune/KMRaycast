...
execute if score $RemainingLength KMRaycast < $NowLengthX KMRaycast run return run function km_raycast:zz/block/raycast/end/limit
...
execute if score $UnitX KMRaycast matches 0.. positioned ~1 ~ ~ run return run function km_raycast:zz/block/raycast/move/.m with storage km_raycast: BlockRaycast.Macro
