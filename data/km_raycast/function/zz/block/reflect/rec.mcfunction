...
# コールバック実行
execute unless data storage km_raycast: {BlockReflect:{Arguments:{CallbackFunction:""}}} run function km_raycast:zz/block/reflect/callback.m with storage km_raycast: BlockReflect.Arguments
