...
execute if score $RemainingReflectCount KMRaycast matches 0.. if score $RemainingLength KMRaycast matches 1.. unless score $LastCollideAxis KMRaycast matches -1 at @s run function km_raycast:zz/block/reflect/rec
