...
execute if score @s KMRaycast > $MinLength KMRaycast run return run scoreboard players reset @s KMRaycast

function km_raycast:zz/entity/raycast/return

scoreboard players set $SearchLength KMRaycast 2000000000
